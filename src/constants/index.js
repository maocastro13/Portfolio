...
const experiences = [
    {
      ...
      points: [
        "----------------FIRST PHASE----------------",
        "Led and managed a team of programmers, artists, and music composers for the final project of Generation Colombia Bootcamp 'Unity Developer'",
        "Implemented Agile methodology and Scrum framework, using weekly sprints for effective team synergy.",
        "Developed software architecture using Solid Principles and pure object-oriented programming for main characters.",
        "Programmed and designed the character 'Garok The Destroyer' with clean and efficient code.",
        "Provided technical assistance to resolve bugs and errors during game development.",
        "Led implementation of the scenario in Unity and managed project integration and compilation.",
        "----------------SECOND PHASE----------------",
        "Recruited music composers, sound designers, and a graphic designer to enhance UI, UX, and sound quality.",
        "Managed team goals and objectives considering time availability for smooth progress.",
        "Established and optimized workflow using Git and GitHub through Bash.",
        "Develop the character 'Sir Percival' and work on the visual effects for him and those of 'Lyra, the Huntress'.",
        "Implemented new music and sound effects using Unity's audio sources and mixer, created an 'AudioManager' for sound management.",
